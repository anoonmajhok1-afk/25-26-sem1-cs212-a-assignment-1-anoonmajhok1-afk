...
def get_user_choice():
    ...
    return # TODO: Add code to return the choice
...
def process_user_command(choice, running, show_goodbye = "Thank you for using Python CLI File Manager!", goodbye_message, 
                        invalid_choice_prefix = "Invalid choice:", valid_commands="Invalid choice:"):
    """
...
display_message # TODO: Call the function to display the welcome message
